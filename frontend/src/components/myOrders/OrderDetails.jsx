...
//  this page is order details page mean all data of order via in this page  so, collect  all data from   state.orders mean order page 
  const { order, loading } = useSelector((state) => state.orders);

  const dispatch = useDispatch();

  useEffect(() => {
    dispatch(getOrderDetails(params.id)); //to access id use --> params.id
  }, [params.id, dispatch]);
